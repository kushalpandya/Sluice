// Inline SVG icon set. Self-contained (no icon font, no CDN) so the bundle
// stays small and the page works behind Cloudflare Access with no external
// host allowances. Paths are 24x24, stroked - add new ones to PATHS.
const PATHS = {
  inbox:
  ...
  bug: 'M8 6V4a4 4 0 0 1 8 0v2M5 10h14v5a7 7 0 1 1-14 0zM2 12h3M19 12h3M4 6l2.5 2M20 6l-2.5 2M4.5 19 7 17M19.5 19 17 17',
  bolt: 'M13 2 3 14h9l-1 8 10-12h-9l1-8z',
  lightbulb: 'M9 21h6M10 17h4M12 3a6 6 0 0 0-4 10.47V17h8v-3.53A6 6 0 0 0 12 3z',
  ...
  'sort-desc': 'M6 4v16M3 17l3 3 3-3M12 6h9M12 12h6M12 18h3',
  'sort-asc': 'M6 20V4M3 7l3-3 3 3M12 6h3M12 12h6M12 18h9',
};

export function Icon({ name, class: cls = '', size = 16 }) {
  const d = PATHS[name];
  if (!d) return null;
  return (
    <svg
